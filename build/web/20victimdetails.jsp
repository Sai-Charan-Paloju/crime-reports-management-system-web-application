...
<body>
    <form id="form" name="myForm" method="post" action="20victimdetailsinsertion.jsp">
<br>
<label for='name' >Enter Victim Name </label>
<input type='text' name='name' id='name' maxlength="50" />
</br>
<br>
<label for='name' >Enter Victim Address </label>
<input type='text' name='address' id='name' maxlength="50" />
</br>
<br>
<label for='name' >Enter Victim Age </label>
<select name="names">
...
<br>
<label for='name' >Enter Victim Phone Number </label>
...
<br>
<a href="20victimdetailsinsertion.jsp"><input type='submit' name='Submit' value='Register'/></a>
</br>
<br>
