...
<table bgcolor="white" border="5" text="white">
  <tr>       
   ...
   <td><center><a href="emergencyno.jsp" target="_top"> Emergency No's</a></center></td>    
    ...
    <center>
    <h1>Assign Crime Status</h1>
<body>
    <form id="form" name="myForm" method="post" action="assigncrimestatusinsertion.jsp">

<br>
<label for='name' >Crime Username </label>
<input type='text' name="crimeid">
</br>
    <br>
<label for='name' >Crime Station </label>
<input type='text' name="crimestation">
</br>
    <br>
<label for='name' >Crime Status</label>
<input type='text' name="crimestatus">
</br>
    <br>
...
<br>
    ...
    <a href="assigncrimestatusinsertion.jsp"><input type="submit" value="Assign"></a> <a href="14stationprofilepage.jsp"><input type='submit' name='Submit' value='Previous Page'/>
</html>
