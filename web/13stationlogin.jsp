...
<body>
<center><h1>Station Login<h1></center>   
       <center>     
            <form action="14stationprofilepage.jsp" method="post" name="form">
</br>
<br>
<td>Station Username</td>
<td><input type="text" size="20" name="suname"</td>
</br>
<br>        
<td>Password</td>
...
<a href="12stationregistrationform.jsp"><input type='submit' name='Submit' value='Register'/></a>
</html>
