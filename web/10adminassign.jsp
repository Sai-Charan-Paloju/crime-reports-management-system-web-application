...
<table bgcolor="white" border="5" text="white">
  <tr>       
   ...
   <td><center><a href="emergencyno.jsp" target="_top"> Emergency No's</a></center></td>    
    ...
    <h1>Admin Assign</h1>
<body>
    <form id="form" name="myForm" method="post" action="adminassigninsertion.jsp">
...
<br>
    ...
    <a href="adminassigninsertion.jsp"><input type="submit" value="Assign"></a> <a href="8adminprofilepage.jsp"><input type='submit' name='Submit' value='Previous Page'/>
</html>
